...
if ( $vars['template'] == "list") { 
        ...
        echo'<div style="margin-right:10px; float:right;"><input class="elgg-button" onclick="toggle_visibility();" type="button" value="Show my games" id="toggleGames" ></div>';

        if (elgg_is_admin_logged_in())

          // "Unauthorized games" button

            echo'<div style="margin-right:10px; float:right;"><input class="elgg-button"  onclick="toggle_unauth_visibility();" type="button" value="Unauthorized games" id="toggleUnauthGames" ></div>';       
    ...
    <?php 
    echo '<div style="margin-top: 10px; font-size:18px; font-weight:bold; text-align:center;">Games</div>';?>
        <!--<div class='score' style='border:1px solid #cccccc; padding:10px; padding-right: 0px; text-align:left;'>-->
