...
// Begin Author: rviguera
    ...
    //this new function retrieves the user badges list

    public function getUserBadgesList($user, $campusSession) {
        return json_decode($this->service("user/badges/" . $campusSession . "/getBadgeList/" . $user));
    }
    
    // this new function retrieves the user abilities list

    public function getUserAbilitiesList($user, $campusSession) {
        return json_decode($this->service("user/abilities/" . $campusSession . "/getAbilityList/" . $user));
    }

   // this new function retrieves the user proficiencies list
    public function getUserProficienciesList($user, $ability, $campusSession) {
        return json_decode($this->service("user/proficiencies/" . $campusSession . "/getProficiencyList/" . $user . "/" . $ability));
    }
